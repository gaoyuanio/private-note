    ...
    function (a, d) {
        a.widget("mobile.slider", a.extend({
            ...
            _create: function () {
                ...
                if (z.slider[0].className = [this.isToggleSwitch ? "ui-slider ui-slider-switch ui-slider-track ui-shadow-inset" : "ui-slider-track ui-shadow-inset", E, F, G].join(""), (this.options.disabled || this.element.prop("disabled")) && this.disable(), this.options.highlight && !this.isToggleSwitch && 0 === this.slider.find(".ui-slider-bg").length && (this.valuebg = function () {
                    var b = c.createElement("div");
        ...
        a.widget("mobile.table", a.mobile.table, {
            ...
            _create: function () {
                ...
                c ? d = b.find("input") : g.empty(), this.headers.not("td").each(function () {
                    ...
                    j && (h = i.add(i.jqmData("cells")), h.addClass(f.classes.priorityPrefix + j), b = (c ? d.eq(e++) : a("<b>" + (i.children("abbr").first().attr("title") || i.text()) + "</b>").appendTo(g).children(0).checkboxradio({
